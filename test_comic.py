...
def test_get_image_location():
    ...
    assert comic.get_image_location("http://imgs.xkcd.com/comics/barrel_cropped_(1).jpg") == os.getcwd() + "/finalComic/1.jpg"
    assert comic.get_image_location("") == os.getcwd() + "/finalComic/1"
