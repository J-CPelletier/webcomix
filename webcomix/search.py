...
def discovery(name: str, url: str, single_page: bool = False, javascript: bool = False, alt_text str = None) -> Tuple[Optional[Comic], Optional[List[Mapping]]]:
    ...
    for next_page, image, tag_image, tag_next, attribute_image, attribute_next in tqdm(
        ...
        try:
            comic = Comic(
                name, url, image_xpath, next_page_xpath, single_page, javascript, alt_text
            )
